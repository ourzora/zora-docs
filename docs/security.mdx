...
- **Issue Description**: Provide a comprehensive description of the issue, emphasizing its potential impact.
- **Location**: Specify the exact location where the vulnerability was identified.
