...
| Module Name                                                           | Mainnet Deployment | API      |   Zora.co    |
|-----------------------------------------------------------------------|--------------------|----------|--------------|
| [Asks](./modules/Asks/zora-v3-asks-latest)                             |     ✅             |   ✅      |    ✅       |
| [Auctions](./modules/ReserveAuctions/zora-v3-reserve-auctions-intro)   |     ✅             |   🔜      |    🔜       |

<br/>

### Installing V3
You can begin building with ZORA V3 by installing the v3 package. 
This package supports `typechain` to make it easier to get started.
...
:::note
We have created a guide on approving to ZORA V3 if you would like to [learn more](../../docs/guides/v3-approvals).
:::
