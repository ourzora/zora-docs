...
[Using the ERC20 Minter contract with the protocol sdk](https://github.com/ourzora/zora-protocol/tree/main/packages/protocol-sdk#minting-an-nft-with-an-erc20-minter)
