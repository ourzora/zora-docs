...
##### A factory that deploys new 721 NFT contracts

> Note: 721 NFTs can ***only*** be created and managed on the contract and API level; users are ***no longer*** able to create or update 721 NFTs on the zora.co UI.
---
