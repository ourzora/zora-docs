...
A create is when a new lazy mint becomes available on the contract.
...
Be aware that often creating a new token and minting occur in the _same_ transaction.
