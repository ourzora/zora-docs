...
```bash
forge create src/MyContract.sol:MyContract --chain-id 999 --rpc-url https://testnet.rpc.zora.co/ --private-key $PRIVATE_KEY --verify --verifier blockscout --verifier-url https://testnet.explorer.zora.energy/api
```
