...
- Lastly, add in the configuration details listed in the network section [here](./network). Once saved, you will then be able to sumbit transactions on the Zora Network.
