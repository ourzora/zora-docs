...
### Adding to MetaMask
Addresses in your MetaMask will work and be the same on both Ethereum and Zora's L2.
However, to submit transactions to Zora you must add the network to your wallet. 
...
- Lastly, add in the configuration details listed in the network section [here](./network). Once saved, you will then be able to sumbit transactions on Zora L2.
