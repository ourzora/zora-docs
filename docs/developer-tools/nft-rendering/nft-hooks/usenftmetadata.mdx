...
Most metadata servers allow remote JSON fetches, however, there is a chance this request could fail when the server
...
To use the hook, simply pass in the metadata URL to fetch:
