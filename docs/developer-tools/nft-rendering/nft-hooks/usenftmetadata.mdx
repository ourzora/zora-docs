...
sidebar_position: 3
custom_edit_url: https://github.com/ourzora/zora-docs/blob/main/docs/developer-tools/nft-rendering/nft-hooks/usenftmetadata.mdx
---
...
Most metadata servers allow for remote JSON fetches, however, there is a chance this request could fail when the server
