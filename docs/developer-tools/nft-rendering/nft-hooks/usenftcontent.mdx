...
title: useNFTContent
sidebar_position: 4
custom_edit_url: https://github.com/ourzora/zora-docs/blob/main/docs/developer-tools/nft-rendering/nft-hooks/usenftcontent.mdx
---
...
when the server does not allow cross-origin requests. Requests are set with a 10 second timeout to allow showing the user
