...
title: User Info
sidebar_position: 6
custom_edit_url: https://github.com/ourzora/zora-docs/blob/main/docs/developer-tools/zdk/user-info.mdx
---

Maps Ethereum addresses to ZORA user profiles

---

The `getZoraProfiles` method queries for the ZORA profile information of a batch of ETH addresses (up to 100).
