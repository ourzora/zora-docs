...
## Read Functions
All functions that are able to get data from the ZORA Auction House smart contract. 
...
All functions that are able to submit transactions to interact with the ZORA Auction House smart contract.
