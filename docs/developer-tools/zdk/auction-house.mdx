...
This module provides tools for making it easy to sell any ERC-721 NFT

---

The ZORA Auction House is an open and permissionless system that allows any creator, community, or DAO to sell an NFT.
The part of the ZDK provides easy access to the Auction House contract, allowing anyone to create, partake, or curate their own auction.
...
Once an auction's timer has run out, anyone is able to end the auction. 
