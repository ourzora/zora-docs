...
The Indexer watches the blockchain and regularly fetches and refreshes NFT metadata data. This makes it easy to query NFTs by their
...
You can directly query for any ERC-721 NFT by querying the `Token` table. The example query fetches the first Blitmap 100 `tokenIds`. 
