...
queries one could make is through a GraphQL client UI. 
...
with the ZORA Protocol, and transactions that result in a transfer of an ERC-721 NFT Contract it is indexing.
...
=======
  ...
  tokenContract // TokenContract has information like name and symbol
  transferEvents // all TokenTransferEvents
>>>>>>> f0fa5e9 (toUpperCase Zora in docs)
}
```

### Media

ZORA NFT - view [Media.sol](https://github.com/ourZORA/core/blob/master/contracts/Media.sol) for context
