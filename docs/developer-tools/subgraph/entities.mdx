...
title: Entities
sidebar_position: 3
custom_edit_url: https://github.com/ourzora/zora-docs/blob/main/docs/developer-tools/subgraph/entities.mdx
---

##### All of the GraphQL entities of the ZORA Subgraph
