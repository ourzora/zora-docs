...
import { askModuleABI } from "../yourABIFile.js";

const provider = new ethers.providers.JsonRpcProvider(); // If you don't specify a url, Ethers connects to localhost 
const asksModuleAddress = "0x6170B3C3A54C3d8c854934cBC314eD479b2B29A3"; // Asks v1.1 Mainnet Ethereum
...
const findersFeeBps = "200"; // 2% Finders Fee

const askModuleContract = new ethers.Contract(asksModuleAddress, askModuleABI, provider);
