...
1.  **Builder DAO Reward** - 2.5%
    Builder DAO, the developer and maintainer of the protocol, receives this reward.
...
3.  **Founder Reward** - _Optional and controlled by individual DAOs_ <br />
    DAOs can choose to distribute up to 50% of the auction revenue to its founder. This can be applied at the time of DAO creation or post-creation. If post-creation, then the DAO can vote on a proposal to assign this reward.

---

### Builder DAO Rewards Recipients

All Builder DAO rewards will go to a 3/6 multisig on each network managed by the DAO's Operations Working Group. The addresses are:
