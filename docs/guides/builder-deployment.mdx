...
Note, that these founder NFTs do not impact the auction cadence.
...
This will take you to the settings page for the DAO. As a founder, you can edit these settings before initializing.
...
This step will start the first auction and also hand over admin controls to DAO governance.
