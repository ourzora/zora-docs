...
:::note
We have created a separate website that allows you to test out deploying a DAO on the Geroli Testnet before trying it on Mainnet.
- Vist the Testnet website [here](https://testnet.nouns.build/).
- Obtain Geroli ETH [here](https://faucet.paradigm.xyz/) or [here](https://goerlifaucet.com/).
:::
---

## General Settings
First, you will need to provide the name, symbol, an image for our DAO and optionally a website.
...
- `Proposal Threshold:` Min percent of total votes (NFTs) needed to put a proposal to a vote.
...
- `Quorum Threshold:` Min percent of total votes (NFTs) required for a proposal to pass
...
The veto can later before removed once the NFTs have become sufficiently decentralized.
...
<img className="guide-photos" src={artPreview} alt="art-preivew" height="500px"/>
...
This step will start the first auction and also hand over all admin controls to DAO governance.
Note, once you initialize your DAO the settings can't be changed by a founder and must pass a governance vote.
