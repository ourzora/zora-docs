...
Tokens must first be approved by the correct Transfer Helper before being able to be used by ZORA V3.
...
Once all the necessary tokens have been approved by the correct Transfer Helpers, 
