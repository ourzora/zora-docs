...
:::note
One thing to call out is that sometimes collections will airdrop their tokens to people to trick certain interfaces into making it look like that address was minted from the collection.
